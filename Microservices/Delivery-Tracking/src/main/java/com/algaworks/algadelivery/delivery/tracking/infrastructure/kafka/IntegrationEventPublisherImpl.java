...
public class IntegrationEventPublisherImpl implements IntegrationEventPublisher {
    ...
    public void publish(Object event, String key, String topic) {
        ...
        // send -> Retorna um resultado assíncrono e para fazer a espera do resultado
        // é necessário chamar o método join()
...
/*
* KafkaTemplate
* Classe responsável por fazer envio dos eventos (mensagens) para o Kafka
*
* */